...
public class Cidades extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        arquivo = new File("/home/fabio/NetBeansProjects/Exercicio2/src/java/cidades/CidadesA.txt");
        ...
        if(arquivo.isDirectory()){
            ...
            try {
                ...
                out.println("<h3>Busca por Cidades</h3>");
                out.println("<ul class=\"nav nav-tabs nav-justified\">");
                out.println("<li class=\"active\"><a href=\"Cidades\">Cidades com '"+request.getParameter("q")+"'</a></li>");
                out.println("<li><a href=\"IncluirCidade\"> Incluir nova cidade </a></li>");
                out.println("</ul>");
                out.println("<br>");
                out.println("<ul class=\"list-group\">");
                while((line = in.readLine())!= null){
                    
                    if(line.contains(request.getParameter("q")))
